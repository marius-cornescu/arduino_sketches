...
void loop() {
    ...
    if (Serial.available()) {
        ...
        // set A1 to one minute past the time we just set the rtcClock
        // on current day of week.
        rtcClock.setA1Time(dOW, hour, minute+1, second, 0x0, true,
                        false, false);
        // set A2 to two minutes past, on current day of month.
        rtcClock.setA2Time(date, hour, minute+2, 0x0, false, false,
                        false);
